namespace Lab_2
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ChangeTime(tm);
            Console.WriteLine(tm);
            // Значение не поменялось, т.к. структуры передаются в методы ПО ЗНАЧЕНИЮ
         ...
         * 3. Пользовательский тип данных можно создать при помощи служебных слов class, struct.
         * 4. В C# для объявления и инициализации переменных пользовательского типа данных, таких как структуры и классы, необходимо сначала определить сам тип, а затем создать его экземпляр.
